...
public class CCNeonFlash : MonoBehaviour 
{
    ...
    void ColorSwitch()
    {
        ...
        if (SwitchModes == SwitchMode.simple)
        {
            ...
            if (mode == 0)
            {
           //     this.gameObject.GetComponent<Renderer>().materials[MatId] = GetComponent<Renderer>().materials[0];
                //_Material.SetColor("_EmissionColor", Color.black);
            }
            else
            {
             //   this.gameObject.GetComponent<Renderer>().materials[MatId] = GetComponent<Renderer>().materials[1];
