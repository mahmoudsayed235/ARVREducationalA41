...
public class playerEvents : MonoBehaviour
{
    ...
    private void CheckInputSource(){
        //update
        m_Controller = UpdateSource(OVRInput.GetActiveController(), m_InputSource);
    ...
    {
        m_LeftAnchor = GameObject.FindGameObjectWithTag("Left");
        m_RightAnchor = GameObject.FindGameObjectWithTag("Right");
        m_HeadAnchor = GameObject.FindGameObjectWithTag("MainCamera");
